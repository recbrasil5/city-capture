...
import { useCityBehavior } from "@/composables/useCityBehavior";
...
<template>
  <div class="panel">
    ...
    <div class="content">
      <h2>
        {{ props.city.name }}
        <img :src="flagUrl(props.city.country)" :alt="props.city.country" class="country-flag" />
      </h2>
      ...
      <div v-if="details">
        ...
        <div v-else class="flag-hero">
          <img :src="flagUrl(props.city.country)" :alt="props.city.country" class="flag-hero-img" />
        </div>
